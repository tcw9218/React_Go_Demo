			...
			>
				<div className="relative flex flex-col justify-center items-start w-full max-xl:padding-x py-10">
					...
					<h1 className="mt-3  text-2xl  font-bold">
						<span className="bg-secondary-default relative z-10 pr-10">Get Our New arrivals Bikes</span>
					</h1>
					<p className=" text-secondary-dark text-lg leading-8 my-6">We can make an offer for your bike </p>
